...
<picture>
  ...
  <img alt="Генрих Багдасарян — Frontend-разработчик" src="./dark-ru.svg" width="100%">
</picture>
...
| [dentboard.ru](https://dentboard.ru) | Рабочее пространство (SaaS) для сотрудников стоматологий — внутренняя система управления | React · TypeScript |
